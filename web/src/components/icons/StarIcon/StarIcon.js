...
const StarIcon = ({ className, semi = false, empty = false, ...props}) => {
    return (
        <svg className={`star-icon ${className ?? ""}`} { ...props } xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
