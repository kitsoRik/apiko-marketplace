	...
	return (
		<ModalDialog opened={opened} onClosed={onClosed}>
			...
			<section className="product-page-buy-dialog-products">
				<CartProductsList
					onCountChange={(id, c) => setCount(c)}
					cartProducts={[{ count, product }]}
				/>
			</section>
			<div className="product-page-buy-dialog-buttons">
				<Button.Default
					className="product-page-buy-dialog-buttons-add-to-cart"
					value="Add to cart"
					onClick={onAddToCardClicked}
				/>
				<Button.Outlined
					className="product-page-buy-dialog-buttons-cancel"
					value="Cancel"
					onClick={onCancelClick}
				/>
				<Button.Default
					className="product-page-buy-dialog-buttons-buy-instant"
					value="Buy instant"
					onClick={onBuyInstantClick}
				/>
			</div>
		</ModalDialog>
	);
