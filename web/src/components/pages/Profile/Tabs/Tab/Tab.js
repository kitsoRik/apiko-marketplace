...
const Tab = ({ main, minor, active, loading, activated }) => {
	const pathD = !active
		? "M1.15 0.65H163.323V73.4579H1.15V0.65Z"
	...
	return (
		...
		>
			<path d={pathD} stroke="#EEEFF1" strokeWidth="2" />
			<foreignObject className="profile-tab-container">
				{!loading && (
					<div xmlns="http://www.w3.org/1999/xhtml">
						<span className="profile-tab-container-main-text">
							{main}
						</span>
						<span className="profile-tab-container-minor-text">
							{minor}
						</span>
					</div>
				)}
